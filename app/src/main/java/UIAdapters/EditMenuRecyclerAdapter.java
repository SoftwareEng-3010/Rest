...
public class EditMenuRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private Context context;
    private List<Item> items;
    private List<Item> selectedItems;

    public EditMenuRecyclerAdapter(Context context, List<Item> menuItems) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        buttonAddRemove.setVisibility(View.GONE);
    }
