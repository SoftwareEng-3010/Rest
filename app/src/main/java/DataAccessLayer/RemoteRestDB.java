...
//    }
//
//    public void getRestaurant(String id, OnDataReceived callBack) {
//
//        restCollection.whereEqualTo(FieldPath.documentId(), id).get()
...
//                                    if (docs.size() > 1) {
//                                        // An error occurred! Only 1 restaurant doc should be returned
//                                        callBack.onObjectReturnedFromDB(null);
//                                    }
//                                    else {
//                                        callBack.onObjectReturnedFromDB(docs.get(0).toObject(Restaurant.class));
//                                    }
//                                }
//                            }
//                        }
...
//    }
//
//    public void getBranch(String restaurantID, OnDataReceived callBack) {
//
//    }
//
